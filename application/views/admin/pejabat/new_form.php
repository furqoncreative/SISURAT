			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('admin/pejabat/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
					</div>
					<div class="card-body">

						<form action="<?php base_url('admin/pejabat/add') ?>" method="post" enctype="multipart/form-data" >
							<div class="form-group">
								<label for="kode_pejabat">Kode pejabat*</label>
								<input class="form-control <?php echo form_error('kode_pejabat') ? 'is-invalid':'' ?>"
								 type="text" name="kode_pejabat" placeholder="Kode pejabat" />
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('nama') ? 'is-invalid':'' ?>"
								 type="text" name="nama" placeholder="Nama pejabat" />
								<div class="invalid-feedback">
